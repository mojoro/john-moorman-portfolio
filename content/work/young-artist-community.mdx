...
week: 7
featured: true
thumbnail: /images/blog/young-artist-community/directory.png
stats:
  - value: "72"
    label: "Commits"
  - value: "21.5h"
...
<Demo
  hero="/images/blog/young-artist-community/directory.png"
  heroAlt="Directory of Young Artist Programs filtered by instrument, location, and tuition."
  caption="The directory. Browse, filter, edit, and review programs Wikipedia-style. No account required to contribute."
  stats={[
    { value: "72", label: "commits" },
    { value: "21.5h", label: "build time" },
    { value: "27", label: "import sources" },
    { value: "~1.2K", label: "lines of OpenAPI" },
  ]}
  live="https://youngartist.community"
  github="https://github.com/mojoro/yactracker"
  blog="/blog/young-artist-community"
  status="shipped"
/>
...
![ER diagram for the Young Artist Community schema, drafted before any code was written.](/images/blog/young-artist-community/erd.png)
