...
<Demo
  stats={[
    { value: "Week 10", label: "of 10-in-10" },
    { value: "React Native", label: "native iOS + Android" },
    { value: "OpenRouter", label: "structured output" },
  ]}
  status="in-progress"
  note="In build. Targeting v1 ship around 2026-05-06. Live links and screencast will land here once it ships."
/>
