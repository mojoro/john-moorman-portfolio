...
week: 6
featured: true
thumbnail: /images/blog/murmur/murmur-reader.png
stats:
  - value: "5"
    label: "TTS engines"
  - value: "Voice clone"
...
<Demo
  hero="/images/blog/murmur/murmur-reader.png"
  heroAlt="The Murmur reader playing back a saved document with one of five swappable TTS engines."
  caption="The reader. Five swappable TTS engines, voice cloning, offline PWA, all self-hosted."
  stats={[
    { value: "5", label: "TTS engines" },
    { value: "PDF·EPUB·DOCX", label: "document import" },
    { value: "PWA", label: "offline-capable" },
  ]}
  github="https://github.com/mojoro/murmur-tts-reader"
  blog="/blog/murmur"
  status="shipped"
  note="Self-hosted only — clone the repo and run docker compose up."
/>
...
<Audio src="/audio/murmur-pocket-tts.wav" title="Pocket TTS — the default, CPU-friendly, eight built-in voices" />

<Audio src="/audio/murmur-cosyvoice.wav" title="CosyVoice 2 — voice clone, fastest of the clone-capable engines" />

<Audio src="/audio/murmur-f5.wav" title="F5 TTS — best overall quality, slowest" />

<Audio src="/audio/murmur-xtts.wav" title="XTTS v2 — disappointed once I got it running" />

<Audio src="/audio/murmur-gpt-sovits.wav" title="GPT-SoVITS — slightly better than XTTS, still not great" />

---

[Full write-up on the blog](/blog/murmur) — including the architecture evolution and the dockerizing ordeal.
