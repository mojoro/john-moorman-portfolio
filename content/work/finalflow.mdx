...
<Demo
  ...
  caption="Pixel-perfect Figma execution in a stack I'd never used. Vue + TypeScript + Tailwind, learned in 10 hours, built in 20."
  stats={[
    { value: "10h", label: "reading docs" },
    { value: "20h", label: "shipping" },
    { value: "Vue + Firebase", label: "client-chosen stack" },
  ]}
