...
<Demo
  stats={[
    { value: "5", label: "services on 1 VM" },
    { value: "Pipecat·Temporal·Twilio", label: "voice stack" },
    { value: "Deepgram·Anthropic", label: "STT, LLM, TTS" },
  ]}
  live="https://quotid.johnmoorman.com/"
  github="https://github.com/mojoro/quotid"
  status="shipped"
  note="Listen to a real call recording at the bottom of this post (coming soon)."
/>
