...
[Full write-up on the blog](/blog/quotid), including the chronological-by-construction transcript design, the `raise_complete_async()` landmine that cost me two hours, and the Hetzner-asks-for-your-passport-after-your-card detour through hosting providers.

[Live site](https://quotid.johnmoorman.com) · GitHub (private for now)
