...
stats:
  ...
  - value: "Pipecat"
    label: "Voice stack"
  - value: "Deepgram·Anthropic"
    label: "STT, LLM, TTS"
---

<Demo
  github="https://github.com/mojoro/quotid"
  note="The AWS free tier expired, so the VM (and with it the nightly calls) is offline until I move it to a cheaper host."
/>
...
The hosted app is offline since the AWS free tier expired. [GitHub](https://github.com/mojoro/quotid)
