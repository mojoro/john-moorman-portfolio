...
<Demo
  ...
  blog="/blog/skip-bo"
  note="The AWS free tier expired, so the hosted game is offline. The code and the write-up are still here, and I'll redeploy on a cheaper host."
/>
...
The hosted game is offline since the AWS free tier expired. [GitHub](https://github.com/mojoro/skip-bo)
