...
challenge: "10-in-10"
week: 1
thumbnail: "/images/blog/real-estate-ai-tool/dashboard.png"
stats:
  - value: "3"
...
<Demo
  hero="/images/blog/real-estate-ai-tool/pipeline-diagram.png"
  heroAlt="End-to-end pipeline: Apify scrapes three platforms, n8n orchestrates dedup, filter, AI analysis, and dispatch."
  caption="The pipeline: Apify scrapes three platforms, n8n orchestrates dedup and AI scoring, Airtable stores, the dashboard surfaces."
  stats={[
    { value: "3", label: "platforms scraped" },
    { value: "GO·NO·PRÜFEN", label: "AI classification" },
    { value: "Daily", label: "automated digest" },
  ]}
  live="https://real-estate-dashboard-brown-seven.vercel.app/"
  liveLabel="Live dashboard"
  github="https://github.com/mojoro/real-estate-dashboard"
  blog="/blog/real-estate-ai-tool"
  status="shipped"
  note="Dashboard runs against mock data so you can browse without a client account."
/>
...
![A sample of the daily digest the client receives every morning.](/images/blog/real-estate-ai-tool/email-digest.png)
