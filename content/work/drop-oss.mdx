...
challenge: "10-in-10"
week: 4
thumbnail: "/images/blog/drop-oss/main-ui.png"
stats:
  - value: "4"
    label: "LLM backends"
  - value: "2"
...
<Demo
  hero="/images/blog/drop-oss/main-ui.png"
  heroAlt="The Drop generation UI: paste a URL, watch each pipeline stage stream in."
  caption="Paste a URL. The pipeline streams: scrape, write, voice. Library auto-saves every generation."
  stats={[
    { value: "4", label: "LLM backends" },
    { value: "2", label: "TTS engines" },
    { value: "AES-256", label: "encrypted profiles" },
  ]}
  github="https://github.com/mojoro/drop"
  blog="/blog/drop-oss"
  status="shipped"
  note="Self-hosted: bring an OpenRouter key, or run Ollama locally and never touch a cloud API."
/>
...
A short podcast generated end-to-end with Drop. Same pipeline you'd run yourself: scrape, write, voice, stitch.

<Audio src="/audio/drop-2026-03-18.mp3" title="Generated with Drop — interview with a man born in 1889, sourced from a 1990s archive page" />
