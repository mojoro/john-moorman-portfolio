...
featured: true
status: "shipped"
thumbnail: "/images/work/boa-automation/lifecycle.svg"
stats:
  - value: "€74K"
...
<Demo
  hero="/images/work/boa-automation/lifecycle.svg"
  heroAlt="The BOA student lifecycle: application, offer letter, payment, confirmation, enrolled, with a deadline-missed branch into reminders and cancellation."
  heroAspect="1080 / 360"
  caption="Every stage of the student lifecycle, automated. Sheets is both the database and the admin UI."
  stats={[
    { value: "€74K", label: "annual savings" },
    { value: "4 → 2", label: "staff" },
    { value: "+18%", label: "payment collection" },
  ]}
  live="https://berlinoperaacademy.com"
  liveLabel="BOA website"
  status="shipped"
  note="Code is proprietary. Happy to walk through the architecture in person — get in touch."
/>
