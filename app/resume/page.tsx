...
const SKILLS = [
  ...
  { label: "AI & Automation", value: "Agent-assisted development with review and verification discipline; Anthropic API, Claude Code, Cursor, n8n, Apify, Google Apps Script" },
]
